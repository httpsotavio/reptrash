...
bool ConditionAttributes::setParam(ConditionParam_t param, int32_t value)
{
	...
	switch (param) {
		...
		case CONDITION_PARAM_STAT_DEXTERITY: {
			stats[STAT_DEXTERITY] = value;
			return true;
		}		

		case CONDITION_PARAM_STAT_STRENGTH: {
			stats[STAT_STRENGTH] = value;
			return true;
		}

		case CONDITION_PARAM_STAT_AGILITY: {
			stats[STAT_AGILITY] = value;
			return true;
		}

		case CONDITION_PARAM_STAT_VITALITY: {
			stats[STAT_VITALITY] = value;
			return true;
		}

		case CONDITION_PARAM_STAT_INTELIGENCE: {
			stats[STAT_INTELIGENCE] = value;
			return true;
		}

		case CONDITION_PARAM_STAT_LUCKY: {
			stats[STAT_LUCKY] = value;
			return true;
		}

		case CONDITION_PARAM_STAT_ATTACKSPEED: {
			stats[STAT_ATTACKSPEED] = value;
			return true;
		}
...
int32_t ConditionAttributes::getParam(ConditionParam_t param)
{
	switch (param) {
		...
		case CONDITION_PARAM_STAT_VITALITY:
			return stats[STAT_VITALITY];

		case CONDITION_PARAM_STAT_INTELIGENCE:
			return stats[STAT_INTELIGENCE];

		case CONDITION_PARAM_STAT_LUCKY:
			return stats[STAT_LUCKY];

		case CONDITION_PARAM_STAT_ATTACKSPEED:
			return stats[STAT_ATTACKSPEED];
