...
enum itemAttrTypes : uint32_t {
	...
	ITEM_ATTRIBUTE_DEXTERITY = 1U << 4,
	ITEM_ATTRIBUTE_STRENGTH = 1U << 5,
	ITEM_ATTRIBUTE_AGILITY = 1U << 6,
	ITEM_ATTRIBUTE_VITALITY = 1U << 7,
	ITEM_ATTRIBUTE_INTELIGENCE = 1U << 8,
	ITEM_ATTRIBUTE_LUCKY = 1U << 9,
	ITEM_ATTRIBUTE_EXTRADAMAGE = 1U << 10,
	ITEM_ATTRIBUTE_SELFHEALING_INCREASE = 1U << 11,
	ITEM_ATTRIBUTE_HEALING_BONUS = 1U << 12,
	ITEM_ATTRIBUTE_PENETRATION = 1U << 13,
	ITEM_ATTRIBUTE_PHYSICAL_DAMAGE_REDUCTION = 1U << 14,
	ITEM_ATTRIBUTE_MAGIC_DAMAGE_REDUCTION = 1U << 15,
	ITEM_ATTRIBUTE_MAXHP = 1U << 16,
	ITEM_ATTRIBUTE_MAXMP = 1U << 17,

	ITEM_ATTRIBUTE_CUSTOM = 1U << 3
};
...
enum ConditionParam_t {
	...
	CONDITION_PARAM_STAT_DEXTERITY = 56,
	CONDITION_PARAM_STAT_STRENGTH = 57,
	CONDITION_PARAM_STAT_AGILITY = 58,
	CONDITION_PARAM_STAT_VITALITY = 59,
	CONDITION_PARAM_STAT_INTELIGENCE = 60,
	CONDITION_PARAM_STAT_LUCKY = 61,
	CONDITION_PARAM_STAT_ATTACKSPEED = 62
};
