...
{
	Database& db = Database::getInstance();
	return loadPlayer(player, db.storeQuery(fmt::format("SELECT `id`, `name`, `account_id`, `group_id`, `sex`, `vocation`, `experience`, `level`, `maglevel`, `health`, `healthmax`, `blessings`, `mana`, `manamax`, `manaspent`, `soul`, `lookbody`, `lookfeet`, `lookhead`, `looklegs`, `looktype`, `lookaddons`, `posx`, `posy`, `posz`, `cap`, `lastlogin`, `lastlogout`, `lastip`, `conditions`, `skulltime`, `skull`, `town_id`, `balance`, `offlinetraining_time`, `offlinetraining_skill`, `stamina`, `skill_fist`, `skill_fist_tries`, `skill_club`, `skill_club_tries`, `skill_sword`, `skill_sword_tries`, `skill_axe`, `skill_axe_tries`, `skill_dist`, `skill_dist_tries`, `skill_shielding`, `skill_shielding_tries`, `skill_fishing`, `skill_fishing_tries`, `direction`, `available_attrpoints`, `dexterity`, `strength`, `agility`, `vitality`, `inteligence`, `lucky` FROM `players` WHERE `id` = {:d}", id)));
}

bool IOLoginData::loadPlayerByName(Player* player, const std::string& name)
{
	Database& db = Database::getInstance();
	return loadPlayer(player, db.storeQuery(fmt::format("SELECT `id`, `name`, `account_id`, `group_id`, `sex`, `vocation`, `experience`, `level`, `maglevel`, `health`, `healthmax`, `blessings`, `mana`, `manamax`, `manaspent`, `soul`, `lookbody`, `lookfeet`, `lookhead`, `looklegs`, `looktype`, `lookaddons`, `posx`, `posy`, `posz`, `cap`, `lastlogin`, `lastlogout`, `lastip`, `conditions`, `skulltime`, `skull`, `town_id`, `balance`, `offlinetraining_time`, `offlinetraining_skill`, `stamina`, `skill_fist`, `skill_fist_tries`, `skill_club`, `skill_club_tries`, `skill_sword`, `skill_sword_tries`, `skill_axe`, `skill_axe_tries`, `skill_dist`, `skill_dist_tries`, `skill_shielding`, `skill_shielding_tries`, `skill_fishing`, `skill_fishing_tries`, `direction`, `available_attrpoints`, `dexterity`, `strength`, `agility`, `vitality`, `inteligence`, `lucky` FROM `players` WHERE `name` = {:s}", db.escapeString(name))));
}
...
bool IOLoginData::loadPlayer(Player* player, DBResult_ptr result)
{
	...
	player->available_attrpoints = result->getNumber<int32_t>("available_attrpoints");
	player->dexterity = result->getNumber<int32_t>("dexterity");
	player->strength = result->getNumber<int32_t>("strength");
	player->agility = result->getNumber<int32_t>("agility");
	player->vitality = result->getNumber<int32_t>("vitality");
	player->inteligence = result->getNumber<int32_t>("inteligence");
	player->lucky = result->getNumber<int32_t>("lucky");
...
bool IOLoginData::savePlayer(Player* player)
{
	...
	query << "`available_attrpoints` = " << static_cast<int32_t> (player->available_attrpoints) << ',';
	query << "`dexterity` = " << static_cast<int32_t> (player->dexterity) << ',';
	query << "`strength` = " << static_cast<int32_t> (player->strength) << ',';
	query << "`agility` = " << static_cast<int32_t> (player->agility) << ',';
	query << "`vitality` = " << static_cast<int32_t> (player->vitality) << ',';
	query << "`inteligence` = " << static_cast<int32_t> (player->inteligence) << ',';
	query << "`lucky` = " << static_cast<int32_t> (player->lucky) << ',';
