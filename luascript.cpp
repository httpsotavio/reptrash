...
void LuaScriptInterface::registerFunctions()
{
	...
	//getSpellIdByName(spellName)
	lua_register(luaState, "getSpellIdByName", LuaScriptInterface::luaGetSpellIdByName);

	//getSpellCooldownByName(spellName)
	lua_register(luaState, "getSpellCooldownByName", LuaScriptInterface::luaGetSpellCooldownByName);	
	
	//getSpellGroupCooldownByName(spellName)
	lua_register(luaState, "getSpellGroupCooldownByName", LuaScriptInterface::luaGetSpellGroupCooldownByName);	
	...
	registerEnum(CONDITION_PARAM_STAT_DEXTERITY)
	registerEnum(CONDITION_PARAM_STAT_STRENGTH)
	registerEnum(CONDITION_PARAM_STAT_AGILITY)
	registerEnum(CONDITION_PARAM_STAT_VITALITY)
	registerEnum(CONDITION_PARAM_STAT_INTELIGENCE)
	registerEnum(CONDITION_PARAM_STAT_LUCKY)
	registerEnum(CONDITION_PARAM_STAT_ATTACKSPEED)
	...
	registerEnum(ITEM_ATTRIBUTE_DEXTERITY)
	registerEnum(ITEM_ATTRIBUTE_STRENGTH)
	registerEnum(ITEM_ATTRIBUTE_AGILITY)
	registerEnum(ITEM_ATTRIBUTE_VITALITY)
	registerEnum(ITEM_ATTRIBUTE_INTELIGENCE)
	registerEnum(ITEM_ATTRIBUTE_LUCKY)
	registerEnum(ITEM_ATTRIBUTE_EXTRADAMAGE)
	registerEnum(ITEM_ATTRIBUTE_SELFHEALING_INCREASE)
	registerEnum(ITEM_ATTRIBUTE_HEALING_BONUS)
	registerEnum(ITEM_ATTRIBUTE_PENETRATION)
	registerEnum(ITEM_ATTRIBUTE_MAXMP)
	registerEnum(ITEM_ATTRIBUTE_MAXHP)
	registerEnum(ITEM_ATTRIBUTE_PHYSICAL_DAMAGE_REDUCTION)
	registerEnum(ITEM_ATTRIBUTE_MAGIC_DAMAGE_REDUCTION)
	...
	registerMethod("Player", "getAvailableAttrPoints", LuaScriptInterface::luaPlayerGetAvailableAttrPoints);
	registerMethod("Player", "setAvailableAttrPoints", LuaScriptInterface::luaPlayerSetAvailableAttrPoints);	
	
	registerMethod("Player", "getDexterity", LuaScriptInterface::luaPlayerGetDexterity);
	registerMethod("Player", "getBaseDexterity", LuaScriptInterface::luaPlayerGetBaseDexterity);
	registerMethod("Player", "setDexterity", LuaScriptInterface::luaPlayerSetDexterity);	
	registerMethod("Player", "setExtraDexterity", LuaScriptInterface::luaPlayerSetExtraDexterity);	
	registerMethod("Player", "getExtraDexterity", LuaScriptInterface::luaPlayerGetExtraDexterity);	
	
	registerMethod("Player", "getStrength", LuaScriptInterface::luaPlayerGetStrength);
	registerMethod("Player", "getBaseStrength", LuaScriptInterface::luaPlayerGetBaseStrength);
	registerMethod("Player", "setStrength", LuaScriptInterface::luaPlayerSetStrength);	
	registerMethod("Player", "setExtraStrength", LuaScriptInterface::luaPlayerSetExtraStrength);	
	registerMethod("Player", "getExtraStrength", LuaScriptInterface::luaPlayerGetExtraStrength);	
	
	registerMethod("Player", "setAgility", LuaScriptInterface::luaPlayerSetAgility);
	registerMethod("Player", "setExtraAgility", LuaScriptInterface::luaPlayerSetExtraAgility);
	registerMethod("Player", "getExtraAgility", LuaScriptInterface::luaPlayerGetExtraAgility);
	registerMethod("Player", "getAgility", LuaScriptInterface::luaPlayerGetAgility);	
	registerMethod("Player", "getBaseAgility", LuaScriptInterface::luaPlayerGetBaseAgility);	
	
	registerMethod("Player", "setVitality", LuaScriptInterface::luaPlayerSetVitality);
	registerMethod("Player", "setExtraVitality", LuaScriptInterface::luaPlayerSetExtraVitality);
	registerMethod("Player", "getExtraVitality", LuaScriptInterface::luaPlayerGetExtraVitality);
	registerMethod("Player", "getVitality", LuaScriptInterface::luaPlayerGetVitality);	
	registerMethod("Player", "getBaseVitality", LuaScriptInterface::luaPlayerGetBaseVitality);	
	
	registerMethod("Player", "setInteligence", LuaScriptInterface::luaPlayerSetInteligence);
	registerMethod("Player", "setExtraInteligence", LuaScriptInterface::luaPlayerSetExtraInteligence);
	registerMethod("Player", "getExtraInteligence", LuaScriptInterface::luaPlayerGetExtraInteligence);
	registerMethod("Player", "getInteligence", LuaScriptInterface::luaPlayerGetInteligence);	
	registerMethod("Player", "getBaseInteligence", LuaScriptInterface::luaPlayerGetBaseInteligence);	
	
	registerMethod("Player", "setLucky", LuaScriptInterface::luaPlayerSetLucky);	
	registerMethod("Player", "setExtraLucky", LuaScriptInterface::luaPlayerSetExtraLucky);	
	registerMethod("Player", "getExtraLucky", LuaScriptInterface::luaPlayerGetExtraLucky);	
	registerMethod("Player", "getLucky", LuaScriptInterface::luaPlayerGetLucky);	
	registerMethod("Player", "getBaseLucky", LuaScriptInterface::luaPlayerGetBaseLucky);	
...
int LuaScriptInterface::luaGetSpellIdByName(lua_State* L)
{
	//getSpellIdByName(spellName)
	Spell* spell = g_spells->getInstantSpellByName(getString(L, 1));
	if (!spell) {
		lua_pushnil(L);
		return 1;
	}
...
int LuaScriptInterface::luaGetSpellCooldownByName(lua_State* L)
{
	//getSpellIdByName(spellName)
	Spell* spell = g_spells->getInstantSpellByName(getString(L, 1));
	if (!spell) {
...
int LuaScriptInterface::luaGetSpellGroupCooldownByName(lua_State* L)
{
	//getSpellGroupCooldownByName(spellName)
	Spell* spell = g_spells->getInstantSpellByName(getString(L, 1));
	if (!spell) {
...
int LuaScriptInterface::luaPlayerGetAvailableAttrPoints(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getAvailableAttrPoints());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetAvailableAttrPoints(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setAvailableAttrPoints(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetDexterity(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getDexterity());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetBaseDexterity(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getBaseDexterity());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetDexterity(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setDexterity(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraDexterity(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setExtraDexterity(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetExtraDexterity(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraDexterity());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetBaseStrength(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getBaseStrength());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetStrength(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setStrength(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraStrength(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setExtraStrength(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetExtraStrength(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraStrength());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetBaseAgility(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getBaseAgility());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetAgility(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setAgility(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraAgility(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setExtraAgility(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetExtraAgility(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraAgility());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetBaseVitality(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getBaseVitality());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetVitality(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setVitality(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraVitality(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setExtraVitality(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetExtraVitality(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraVitality());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetInteligence(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getInteligence());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetBaseInteligence(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getBaseInteligence());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetInteligence(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setInteligence(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraInteligence(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setExtraInteligence(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetExtraInteligence(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraInteligence());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetLucky(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getLucky());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetBaseLucky(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getBaseLucky());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetLucky(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setLucky(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraLucky(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setExtraLucky(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetExtraLucky(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraLucky());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraAttackSpeed(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setExtraAttackSpeed(getNumber<int32_t>(L, 2));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerCastSpell(lua_State* L)
{
	...
	Player* player = getUserdata<Player>(L, 1);
	InstantSpell* spell = g_spells->getInstantSpellByName(getString(L, 2));
