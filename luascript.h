...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaGetSpellIdByName(lua_State* L);

		static int luaGetSpellCooldownByName(lua_State* L);

		static int luaGetSpellGroupCooldownByName(lua_State* L);
		...
		static int luaPlayerGetAvailableAttrPoints(lua_State* L);
		static int luaPlayerSetAvailableAttrPoints(lua_State* L);
		static int luaPlayerGetDexterity(lua_State* L);
		static int luaPlayerGetBaseDexterity(lua_State* L);
		static int luaPlayerSetDexterity(lua_State* L);
		static int luaPlayerSetExtraDexterity(lua_State* L);
		static int luaPlayerGetExtraDexterity(lua_State* L);
		static int luaPlayerGetStrength(lua_State* L);
		static int luaPlayerGetBaseStrength(lua_State* L);
		static int luaPlayerSetStrength(lua_State* L);
		static int luaPlayerSetExtraStrength(lua_State* L);
		static int luaPlayerGetExtraStrength(lua_State* L);
		static int luaPlayerSetAgility(lua_State* L);
		static int luaPlayerSetExtraAgility(lua_State* L);
		static int luaPlayerGetExtraAgility(lua_State* L);
		static int luaPlayerGetAgility(lua_State* L);
		static int luaPlayerGetBaseAgility(lua_State* L);
		static int luaPlayerSetVitality(lua_State* L);
		static int luaPlayerSetExtraVitality(lua_State* L);
		static int luaPlayerGetExtraVitality(lua_State* L);
		static int luaPlayerGetVitality(lua_State* L);
		static int luaPlayerGetBaseVitality(lua_State* L);
		static int luaPlayerGetInteligence(lua_State* L);
		static int luaPlayerGetBaseInteligence(lua_State* L);
		static int luaPlayerSetInteligence(lua_State* L);
		static int luaPlayerSetExtraInteligence(lua_State* L);
		static int luaPlayerGetExtraInteligence(lua_State* L);
		static int luaPlayerSetLucky(lua_State* L);
		static int luaPlayerSetExtraLucky(lua_State* L);
		static int luaPlayerGetExtraLucky(lua_State* L);
		static int luaPlayerGetLucky(lua_State* L);
		static int luaPlayerGetBaseLucky(lua_State* L);

		static int luaPlayerGetExtraAttackSpeed(lua_State* L);
		static int luaPlayerSetExtraAttackSpeed(lua_State* L);
