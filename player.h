...
class Player final : public Creature, public Cylinder
{
	public:
		...
		int32_t getAvailableAttrPoints()  const {
			return available_attrpoints;
		}

		int32_t setAvailableAttrPoints(int32_t value) {
			available_attrpoints = value;
			return 0;
		}

		int32_t getDexterity() const {
			return dexterity + extraDexterity;
		}		
		
		int32_t getExtraDexterity() const {
			return extraDexterity + varStats[STAT_DEXTERITY];
		}

		int32_t getBaseDexterity() const {
			return dexterity;
		}		

		int32_t setDexterity(int32_t value) {
			dexterity = value;
			return 0;
		}		
		
		int32_t setExtraDexterity(int32_t value) {
			extraDexterity = value;
			return 0;
		}

		int32_t setStrength(int32_t value) {
			strength = value;
			return 0;
		}		
		
		int32_t setExtraStrength(int32_t value) {
			extraStrength = value;
			return 0;
		}

		int32_t getExtraStrength() const {
			return extraStrength;
		}
		
		int32_t getStrength() const {
			return strength + extraStrength;
		}			
		
		int32_t getBaseStrength() const {
			return strength;
		}		
		
		int32_t setExtraAgility(int32_t value) {
			extraAgility = value;
			return 0;
		}		
		
		int32_t getExtraAgility() const {
			return extraAgility + varStats[STAT_STRENGTH];
		}
		
		int32_t setAgility(int32_t value) {
			agility = value;
			return 0;
		}
		
		int32_t getAgility() const {
			return agility + extraAgility;
		}				
		
		int32_t getBaseAgility() const {
			return agility;
		}		
		
		int32_t setVitality(int32_t value) {
			vitality = value;
			return 0;
		}		
		
		int32_t setExtraVitality(int32_t value) {
			extraVitality = value;
			return 0;
		}

		int32_t getExtraVitality() const {
			return extraVitality + varStats[STAT_VITALITY];
		}
		
		
		int32_t getVitality() const {
			return vitality + extraVitality;
		}			
		
		int32_t getBaseVitality() const {
			return vitality;
		}		
		
		int32_t setExtraInteligence(int32_t value) {
			extraInteligence = value;
			return 0;
		}	

		int32_t getExtraInteligence() const {
			return extraInteligence + varStats[STAT_INTELIGENCE];
		}
		
		int32_t setInteligence(int32_t value) {
			inteligence = value;
			return 0;
		}
		
		int32_t getInteligence() const {
			return inteligence + extraInteligence;
		}				
		
		int32_t getBaseInteligence() const {
			return inteligence;
		}		
		
		int32_t setExtraLucky(int32_t value) {
			extraLucky = value;
			return 0;
		}		

		int32_t getExtraLucky() const {
			return extraLucky + varStats[STAT_LUCKY];
		}
		
		int32_t setLucky(int32_t value) {
			lucky = value;
			return 0;
		}
		
		int32_t getLucky() const {
			return lucky + extraLucky;
		}				
		
		int32_t getBaseLucky() const {
			return lucky;
		}	

		int32_t getFAttackSpeed() const {
			return extraAttackSpeed;
		}	
		
		int32_t getExtraAttackSpeed() const {
			return extraAttackSpeed + varStats[STAT_ATTACKSPEED];
		}		

		int32_t setExtraAttackSpeed(int32_t value) {
			extraAttackSpeed = value;
			return 0;
		}			
		
		int32_t getCooldownReduction() const {
			return varStats[STAT_COOLDOWNREDUCTION];
		}		

		int32_t getTrueDamage() const {
			return varStats[STAT_TRUEDAMAGE];
		}

		int32_t getExtraBossDamage() const {
			return varStats[STAT_BOSSDAMAGE];
		}

		int32_t getExtraRaceDamage(RaceType_t race) const {

			if (race == RACE_BLOOD) {
				return varStats[RACE_BLOOD] || 0;
			}	

			if (race == RACE_ENERGY) {
				return varStats[RACE_ENERGY] || 0;
			}	

			if (race == RACE_FIRE) {
				return varStats[RACE_FIRE] || 0;
			}	

			if (race == RACE_VENOM) {
				return varStats[RACE_VENOM] || 0;
			}			
			
			if (race == RACE_UNDEAD) {
				return varStats[RACE_UNDEAD] || 0;
			}
			return 0;
		}

		int32_t getSpellMPReduction() const {
			return spellMPReduction + varStats[STAT_SPELLMPRED];
		}		
		int32_t setSpellMPReduction(int32_t value) {
			spellMPReduction = value;
			return 0;
		}
		...
		int32_t getMaxHealth() const override {
			int32_t HP = std::max<int32_t>(1, healthMax + varStats[STAT_MAXHITPOINTS]);
			HP += (HP / 100) * vitality;
			return HP;
		}
		...
		uint32_t getMaxMana() const {
			int32_t MP = std::max<int32_t>(0, manaMax + varStats[STAT_MAXMANAPOINTS]);
			MP += (MP / 100) * inteligence;
			return MP;
		}
	...
	private:
		...
		int32_t idleTime = 0;
		int32_t available_attrpoints = 0;
		int32_t dexterity = 0;
		int32_t strength = 0;
		int32_t agility = 0;
		int32_t vitality = 0;
		int32_t inteligence = 0;
		int32_t lucky = 0;
		int32_t extraDexterity = 0;
		int32_t extraStrength = 0;
		int32_t extraAgility = 0;
		int32_t extraVitality = 0;
		int32_t extraInteligence = 0;
		int32_t extraLucky = 0;
		int32_t extraAttackSpeed = 0;
		int32_t spellMPReduction = 0;
