...
void ProtocolGame::sendMarketDetail(uint16_t itemId)
{
	...
	if (it.abilities) {
		...
		if (it.abilities->stats[STAT_DEXTERITY] != 0) {
			if (separator) {
				ss << ", ";
			} else {
				separator = true;
			...
			ss << "dexterity " << std::showpos << it.abilities->stats[STAT_DEXTERITY] << std::noshowpos;
		}		
		
		if (it.abilities->stats[STAT_STRENGTH] != 0) {
			if (separator) {
				ss << ", ";
			} else {
				separator = true;
			...
			ss << "strength " << std::showpos << it.abilities->stats[STAT_STRENGTH] << std::noshowpos;
		}	

		if (it.abilities->stats[STAT_AGILITY] != 0) {
			if (separator) {
				ss << ", ";
			} else {
				separator = true;
			...
			ss << "agility " << std::showpos << it.abilities->stats[STAT_AGILITY] << std::noshowpos;
		}

		if (it.abilities->stats[STAT_VITALITY] != 0) {
			if (separator) {
				ss << ", ";
			} else {
				separator = true;
			...
			ss << "vitality " << std::showpos << it.abilities->stats[STAT_VITALITY] << std::noshowpos;
		}

		if (it.abilities->stats[STAT_LUCKY] != 0) {
			if (separator) {
				ss << ", ";
			} else {
				separator = true;
			...
			ss << "lucky " << std::showpos << it.abilities->stats[STAT_LUCKY] << std::noshowpos;
		}

		if (it.abilities->stats[STAT_INTELIGENCE] != 0) {
			if (separator) {
				ss << ", ";
			} else {
				separator = true;
			...
			ss << "inteligence " << std::showpos << it.abilities->stats[STAT_INTELIGENCE] << std::noshowpos;
		}

		if (it.abilities->stats[STAT_ATTACKSPEED] != 0) {
			if (separator) {
				ss << ", ";
			} else {
				separator = true;
			...
			ss << "attack speed " << std::showpos << it.abilities->stats[STAT_ATTACKSPEED] << std::noshowpos;
		}

		if (it.abilities->stats[STAT_SPELLMPRED] != 0) {
			if (separator) {
				ss << ", ";
			} else {
				separator = true;
			...
			ss << "spell mpcost reduction " << std::showpos << it.abilities->stats[STAT_SPELLMPRED] << std::noshowpos;
		}

		if (it.abilities->stats[STAT_COOLDOWNREDUCTION] != 0) {
			if (separator) {
				ss << ", ";
			} else {
				separator = true;
			...
			ss << "spell cooldown reduction " << std::showpos << it.abilities->stats[STAT_COOLDOWNREDUCTION] << std::noshowpos;
		}
