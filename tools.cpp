...
itemAttrTypes stringToItemAttribute(const std::string& str)
{
	if (str == "aid") {
		...
		return ITEM_ATTRIBUTE_DEXTERITY;
	} else if (str == "strength") {
		return ITEM_ATTRIBUTE_STRENGTH;
	} else if (str == "agility") {
		return ITEM_ATTRIBUTE_AGILITY;
	} else if (str == "vitality") {
		return ITEM_ATTRIBUTE_VITALITY;
	} else if (str == "inteligence") {
		return ITEM_ATTRIBUTE_INTELIGENCE;
	} else if (str == "lucky") {
		return ITEM_ATTRIBUTE_LUCKY;
	} else if (str == "extradamage") {
		return ITEM_ATTRIBUTE_EXTRADAMAGE;
	} else if (str == "selfhealing") {
		return ITEM_ATTRIBUTE_SELFHEALING_INCREASE;
	} else if (str == "healingbonus") {
		return ITEM_ATTRIBUTE_HEALING_BONUS;
	} else if (str == "physicaldamagereduction") {
		return ITEM_ATTRIBUTE_PHYSICAL_DAMAGE_REDUCTION;
	} else if (str == "magicdamagereduction") {
		return ITEM_ATTRIBUTE_MAGIC_DAMAGE_REDUCTION;
	} else if (str == "penetration") {
		return ITEM_ATTRIBUTE_PENETRATION;
	} else if (str == "maxhp") {
		return ITEM_ATTRIBUTE_MAXHP;
	} else if (str == "maxmp") {
		return ITEM_ATTRIBUTE_MAXMP;
	}
